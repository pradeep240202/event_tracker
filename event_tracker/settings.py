...
SECRET_KEY = "django-insecure-6$cc3)l3=(f2ctt2^xq_=l1q&vdq=g+b)%c$$$wx1#iva&tbes"
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('SQLITE_DB_PATH', os.path.join(BASE_DIR, 'db.sqlite3')),  # Default to db.sqlite3 in the project root
    }
}
